									...
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											<td class="product-des" data-title="Description">
												...
												<p class="product-des">Thank you for shopping with us! Here’s a summary of your cart: You’ve selected a Classic Denim Jacket made from premium, durable denim, featuring a relaxed fit with button-up closure and chest pockets—ideal for casual layering. Next, you added an Elegant Maxi Dress, perfect for special occasions, with a flowing A-line silhouette, soft V-neckline, and pleats for a graceful look. For extra warmth, you chose the Cozy Knit Cardigan, a longline, ultra-soft layering piece with an open front, ribbed cuffs, and side pockets. Together, these pieces bring style, versatility, and comfort to your wardrobe. Enjoy your selections!</p>
											</td>

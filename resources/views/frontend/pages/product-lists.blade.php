...
@section('title','Eshop || PRODUCT PAGE')
										...
										<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
											<div class="quickview-content">
												...
												@php
													$after_discount=($product->price-($product->price*$product->discount)/100);
												@endphp
												<h3><small><del class="text-muted">${{number_format($product->price,2)}}</del></small>    ${{number_format($org,2)}}{{number_format($org,2)}}{{number_format($org,2)}}{{number_format($after_discount,2)}}  </h3>

...
@section('title','Eshop || Blog Detail page')
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>By Siya Singh</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>7 Nov, 2024. Thu</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>Comment ({{$post->allComments->count()}})</a></span>
                                    </div>
                                    ...
                                    <div class="content">
                                        ...
                                        @endif
                                        <p>In today’s fast-paced world, online shopping offers unparalleled convenience. Discover tips and tricks to enhance your shopping experience, from utilizing filters and reviews to finding the best deals. Learn how to navigate your favorite eCommerce platforms like a pro!</p>
                                    </div>
                                </div>
